...
public:
  int calculate(int n) {
    ...
    for (n--; n > 0; n--) {
      ...
      b = bit_xor&15; t |= b > 10 ? b - 10 : b;
      b = (bit_xor>>4)&15; t |= (b > 10 ? b - 10 : b)<<4;
      b = (bit_xor>>8)&15; t |= (b > 10 ? b - 10 : b)<<8;
      b = (bit_xor>>12)&15; t |= (b > 10 ? b - 10 : b)<<12;
      b = (bit_xor>>16)&15; t |= (b > 10 ? b - 10 : b)<<16;
      b = (bit_xor>>20)&15; t |= (b > 10 ? b - 10 : b)<<20;
      b = (bit_xor>>24)&15; t |= (b > 10 ? b - 10 : b)<<24;
      x = t;
    }
    return normal(x);
  }
